...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'password_hash' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'created' => '2019-10-18 03:43:24',
                'modified' => '2019-10-18 03:43:24'
            ],
        ];
        parent::init();
    }
